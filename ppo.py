...
class PPO():
    def __init__(self,
        ...
        # setup logging
        self.checkpoint_path = self.checkpoint_path2 = None
    ...
    def compute_loss(self, sample):
        ...
        # compute total loss
        total_loss = self.value_coef * value_loss + self.dyn_coef * dynamics_loss + (policy_loss - self.entropy_coef * entropy)
    ...
    def save_checkpoint(self, path=None, ob_rms=None):
        if self.checkpoint_path is None or self.checkpoint_path2 is None:
            return
        ...
        if path is None:
            ...
            print('Saved checkpoint to {}'.format(self.checkpoint_path))
        else:
